  ...
  return (
    <section className='bg-[url(image2.svg)] w-full bg-cover bg-no-repeat overflow-hidden md:px-10 py-5'>
      <div className='w-full md:w-[50%] px-10 mb-5 '>
        ...
        <p className=' leading-6 text-white py-4 mb-5'>Train an aiDR on your ICP and messaging matrix. <br/> Activate it on a patch. It will send personalized <br/> sequences to every target contact.</p>

...
function Partnar() {
  return (
    <section className='bg-[#07292F]'>
      ...
      <div className='grid grid-cols-2 place-items-center items-center content-center md:justify-center md:place-items-center py-5 md:grid-cols-5 lg:grid-cols-5 xl:grid-cols-5 gap-2'>
